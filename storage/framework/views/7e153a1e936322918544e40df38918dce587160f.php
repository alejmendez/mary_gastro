    ...
    <div class="auto-container">
        <div class="row clearfix">
            ...
            <div class="step-column col-md-3 col-sm-6 col-xs-12">
                <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <a href="<?php echo e(url('backend')); ?>" style="font-size: 20px;">
                    <div class="image-box">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                           <center>  <a href="<?php echo e(url('/backend')); ?>"  class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 wpcf7-form-control wpcf7-submit theme-btn btn-style-one" >CONSULTAS EN LINEA</a></center>
                                        </div>
                                    </div>
                                </div>
