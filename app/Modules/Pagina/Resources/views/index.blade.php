        ...
        <div class="row clearfix">
            <div class="featured-service col-md-4 col-sm-6 col-xs-12">
                <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <div class="image-box">
                        <figure class="image"><a href="#forma_parte_nuestro_team"><img width="370" height="250" src="{{ asset('public/img/featured-image-1.jpg') }}" class="attachment-370x250 size-370x250 wp-post-image" alt="featured-image-1" /></a></figure>
            ...
            <div class="column video-column col-md-6 col-sm-12 col-xs-12">
                <div class="inner-box">
                    <div class="video-image-box">
                        <figure class="image">
                            <img src="{{ asset('public/img/featured-image-20.jpg') }}" alt="" />
                        </figure>
            ...
            <div class="step-column col-md-3 col-sm-6 col-xs-12">
                <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <div class="lower-content">
                        <a href="{{ url('backend') }}" style="font-size: 20px;">Ingresa y regístrate gratis</a>
