<div id="{{ isset($id) ? $id : 'modalTablaBusqueda' }}" class="modal modal-busqueda fade" tabindex="-1" role="dialog">
	<div class="modal-dialog container">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">{{ isset($titulo) ? $titulo : 'Buscar' }}
			...
			<div class="modal-body">
				...
				<table id="{{ isset($idTabla) ? $idTabla : 'tabla' }}" class="table table-striped table-hover table-bordered">
					<thead>
						<tr>
							@foreach($columnas as $columna => $ancho)
