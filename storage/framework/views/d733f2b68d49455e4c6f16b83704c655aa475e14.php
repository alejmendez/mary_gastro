   ...
   <div class="auto-container">
      ...
      <div class="widgets-section">
         <div class="row clearfix">
            <div id="bunch_abous_us-2"  class="col-md-4 col-sm-6 col-xs-12 footer-column widget_bunch_abous_us">
               <div class="footer-widget">
                  <div class="about-widget">
                     <div class="footer-logo">
                        <figure><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('public/img/logo-3-4.png')); ?>" alt=""></a></figure>
                     </div>
                     <div class="widget-content">
                        ...
                        <a href="<?php echo e(url('consulta')); ?>" class="theme-btn btn-style-four">Consulta Online</a>
                     </div>
                  </div>
               </div>
            </div>

            <div id="text-2"  class="col-md-4 col-sm-6 col-xs-12 footer-column widget_text">
               <div class="footer-widget">
                     ...
                     <div class="links-widget">
                        ...
                        <div class="widget-content">
                           <div class="row clearfix">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                 <ul class="list">
                                    <li><a href="<?php echo e(url('consulta')); ?>">Citas</a></li>
         ...
         <div class="clearfix">
            ...
            <div class="pull-right">
               <ul class="footer-social">
                  <li>Sígueme</li>
                  <li><a href="<?php echo e(url('https://www.facebook.com/Maryraida?lst=1312639878%3A1160595543%3A1502303458')); ?>'"><span class="fa fa-facebook"></span></a></li>
