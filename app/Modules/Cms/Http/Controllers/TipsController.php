...
//Request
use marygastro\Modules\Cms\Http\Requests\TipsRequest;
...
class TipsController extends Controller
{
    ...
    public function guardar(TipsRequest $request, $id = 0)
    {
        DB::beginTransaction();
        try{
    ...
    {
        $sql = Tips::select([
            'id', 'titulo', 'descripcion', 'deleted_at'
        ]);
