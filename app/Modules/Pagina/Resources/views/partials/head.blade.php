...
<!--
  <link rel='stylesheet' type='text/css' id='woocommerce-layout-css'  href="{{ asset('public/css/pagina/woocommerce-layout91ac44444.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='woocommerce-smallscreen-css'  href="{{ asset('public/css/pagina/woocommerce-smallscreen91ac.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='woocommerce-general-css'  href="{{ asset('public/css/pagina/woocommerce91ac.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='animate-css'  href="{{ asset('public/css/pagina/animate.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='owl-theme-css'  href="{{ asset('public/css/pagina/owl.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='ecomanic_woocommerce-css'  href="{{ asset('public/css/pagina/woocommerce.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='js_composer_front-css'  href="{{ asset('public/css/pagina/jquery-ui.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='bootstrap-css'  href="{{ asset('public/css/pagina/bootstrap.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='gui-css'  href="{{ asset('public/css/pagina/jquery-ui.css') }}?v={{ env('APP_VERSION') }}" />
<link rel='stylesheet' type='text/css' id='fontawesom-css'  href="{{ asset('public/css/pagina/font-awesome.css') }}?v={{ env('APP_VERSION') }}" />
-->
